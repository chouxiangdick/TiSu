...
AI 教练不只是算数据出计划——在你不想动的时候推你一把，在你累了的时候给你空间。

Agent 会在这些时刻给你来一句：

| 场景 | Agent 会说 |
|------|-----------|
| 连续 3 天全勤 | 🔥 **勤奋者他日不留悔恨** — 今天状态一般？减量但别停 |
| 偷懒了一天 | 💪 一天不练影响不大，**但别让明天再写悲歌** |
| PR 破纪录 | 🏆 **纪录就是用来破的**，下次目标 +2.5kg |
| 减脂平台期 | 📉 体重没动？围度呢？照片呢？**数据不只看一个维度** |
| 受伤/生病休息 | 🛌 **休息也是训练的一部分**，恢复好了再冲 |

> 🎯 鼓励不廉价，不尬吹。每句金句都跟实际表现挂钩，不说空话。
